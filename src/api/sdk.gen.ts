 ...
 * Get Problem Task
 */
export const getProblemTask = <ThrowOnError extends boolean = false>(options: Options<GetProblemTaskData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProblemTaskResponse, GetProblemTaskError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get task versions from before this task
 */
export const getProblemTaskVersions = <ThrowOnError extends boolean = false>(options: Options<GetProblemTaskVersionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProblemTaskVersionsResponse, GetProblemTaskVersionsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getProblemLeaderboard = <ThrowOnError extends boolean = false>(options: Options<GetProblemLeaderboardData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProblemLeaderboardResponse, GetProblemLeaderboardError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Upload Files To Problem
 */
export const uploadFilesToProblem = <ThrowOnError extends boolean = false>(options: Options<UploadFilesToProblemData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, UploadFilesToProblemError, ThrowOnError>({
...
/**
 * Delete File From Problem
 */
export const deleteFileFromProblem = <ThrowOnError extends boolean = false>(options: Options<DeleteFileFromProblemData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, DeleteFileFromProblemError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Mark a task attempt for submission
 */
export const submitTaskAttempt = <ThrowOnError extends boolean = false>(options: Options<SubmitTaskAttemptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, SubmitTaskAttemptError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Unmark a task attempt for submission
 */
export const unsubmitTaskAttempt = <ThrowOnError extends boolean = false>(options: Options<UnsubmitTaskAttemptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, UnsubmitTaskAttemptError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const deleteProject = <ThrowOnError extends boolean = false>(options: Options<DeleteProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, DeleteProjectError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updateProject = <ThrowOnError extends boolean = false>(options: Options<UpdateProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, UpdateProjectError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Update users' roles in project
 */
export const updateUsersInProject = <ThrowOnError extends boolean = false>(options: Options<UpdateUsersInProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<unknown, UpdateUsersInProjectError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const removeUserFromProject = <ThrowOnError extends boolean = false>(options: Options<RemoveUserFromProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, RemoveUserFromProjectError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getFile = <ThrowOnError extends boolean = false>(options: Options<GetFileData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetFileError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
